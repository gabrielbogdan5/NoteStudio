...
const CACHE_NAME    = 'notestudio-v4';
const RUNTIME_CACHE = 'notestudio-runtime-v4';
...
async function syncNotes() {
  /* NoteStudio uses localStorage — notes are always local.
     This hook exists for future cloud-sync capability. */
...
async function periodicSyncNotes() {
  /* Re-cache the app shell to keep it fresh */
  try {
...
/* ──────────────────────────────────────────────
   PUSH NOTIFICATIONS (structure — requires server)
   ────────────────────────────────────────────── */
