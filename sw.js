...
const PRECACHE_URLS = [
  '/NoteStudio-web/',
  '/NoteStudio-web/index.html',
  '/NoteStudio-web/manifest.json',
  '/NoteStudio-web/icon-192x192.png',
  '/NoteStudio-web/icon-512x512.png'
];
...
async function cacheFirst(request, cacheName) {
  ...
  try {
    ...
    return caches.match('/NoteStudio-web/') ||
           caches.match('/NoteStudio-web/index.html');
  }
}
